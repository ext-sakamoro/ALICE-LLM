...
//! Phase 11 (次 session、user 実行): Track 5-4 K3 accept length 実測 (real K3 566GB weights + trained head、`speculative_dspark_dual --confidence-head` を K3 draft で走らせて accept rate / tok/s / speedup を測定、Zenn 記事に publish)
//!
